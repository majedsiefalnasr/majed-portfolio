...
<template>
  <div class="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
    <!-- Header -->
    <div class="mb-12">
      <h1 class="text-foreground mb-4 text-4xl font-bold">Case Studies</h1>
      <p class="text-muted-foreground text-lg">
        Portfolio of web development projects and client work showcasing
        expertise in modern frameworks and best practices
      </p>
    </div>
